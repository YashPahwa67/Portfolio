...
export function Hero() {
  ...
  // Two-column "you + intro" layout when a portrait photo is configured.
  if (portraitSrc) {
    return (
      <section
        id="hero"
      ...
      >
        <div className="mx-auto grid w-full max-w-content items-center gap-12 md:grid-cols-2 md:gap-8">
